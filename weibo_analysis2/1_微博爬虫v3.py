...
if __name__ == '__main__':
	# 爬取前几页
	max_search_page = 2  # 爬前n页
	# 爬取关键字列表
	keywordlistsummary = open('weibo_analysis3/keywordlist.csv2', 'r', encoding='utf8').read().strip().split('\n')
	for search_keyword in keywordlistsummary:
		# 保存文件名
		try:
